...
<li>
	<details>
		...
		text.ctaTertiary, text.anchorPrimary, text.anchorSecondary, text.userInput, text.inputLabel,
		text.inputError, text.inputLabelSupporting, text.inputChecked, text.inputHover,
		text.groupLabel, text.groupLabelSupporting, text.newsInverse text.inputChecked,
		text.inputHover
	</details>
</li>

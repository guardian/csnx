...
If your site uses the Guardian CMP `@guardian/consent-manager`, you should include a `FooterButton` object in the `links` prop with an `onClick` callback that launches the CMP and the text "Privacy Settings".

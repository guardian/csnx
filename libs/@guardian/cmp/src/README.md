...
- [CMP (Consent Management Platform)](#cmp-consent-management-platform)
  - [Table of Contents](#table-of-contents)
  - [Managing Consent](#managing-consent)
    - [`cmp.init(options)`](#cmpinitoptions)
      - [`options.country`](#optionscountry)
      - [`options.pubData`](#optionspubdata)
        - [`pubData.pageViewId`](#pubdatapageviewid)
      - [Example](#example)
  ...
  - [Using Consent](#using-consent)
    - [`onConsentChange(callback, final?)`](#onconsentchangecallback-final)
      - [`callback(consentState)`](#callbackconsentstate)
        - [`consentState.tcfv2`](#consentstatetcfv2)
        - [`consentState.usnat`](#consentstateusnat)
        - [`consentState.aus`](#consentstateaus)
        - [`consentState.canTarget`](#consentstatecantarget)
        - [`consentState.framework`](#consentstateframework)
      - [Example](#example-4)
    - [`onConsent()`](#onconsent)
    - [`getConsentFor(vendor, consentState)`](#getconsentforvendor-consentstate)
      - [`vendor`](#vendor)
      - [TCFV2 vendors](#tcfv2-vendors)
      - [Aus only Vendors](#aus-only-vendors)

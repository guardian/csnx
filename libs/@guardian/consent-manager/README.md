...
[![npm (scoped)](https://img.shields.io/npm/v/@guardian/consent-manager)](https://www.npmjs.com/package/@guardian/consent-manager)
[![ES version](https://badgen.net/badge/ES/2020/cyan)](https://tc39.es/ecma262/2020/)
![Types](https://img.shields.io/npm/types/@guardian/consent-manager)
...
```bash
yarn add @guardian/consent-manager
```

or

```bash
npm install @guardian/consent-manager
```

then

```js
import { getConsentFor, ...etc } from '@guardian/consent-manager';
```
